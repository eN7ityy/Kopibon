...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library::library_get_by_id,
            commands::library::library_get_all_ids,
            commands::library::library_get_paginated,
            commands::library::library_get_paginated_grouped,
            commands::library::library_get_series_members,
            commands::library::library_get_series_facts,
            commands::library::library_find_series,
            commands::library::library_get_by_gallery_id,
            commands::library::library_get_gallery_tags,
            commands::library::library_search,
            commands::library::library_get_artists,
            commands::library::library_get_all_artist_names,
            commands::library::library_get_all_series_names,
            commands::library::library_get_all_tag_names,
            commands::library::library_count,
            commands::library::library_get_scan_status,
            commands::library::library_autocomplete_artists,
            commands::library::library_autocomplete_series,
            commands::library::library_autocomplete_tags,
            commands::library::library_get_page_count,
            commands::library::library_get_thumbnail,
            commands::library::library_is_path_accessible,
            commands::library::file_read,
            commands::library::cbz_read_page,
            commands::library::cbz_get_page_count,
            commands::library_mutate::library_set_gallery_id,
            commands::library_mutate::library_update_metadata,
            commands::library_mutate::library_add_custom,
            commands::library_mutate::library_assign_series,
            commands::library_mutate::library_delete,
            commands::library_mutate::library_delete_file,
            commands::library_mutate::library_delete_multiple,
            commands::library_mutate::library_delete_file_multiple,
            commands::library_mutate::library_rename_series,
            commands::library_mutate::library_set_series_dissolved,
            commands::library_mutate::library_set_series_cover,
            commands::library_mutate::library_preview_series_grouping,
            commands::library_mutate::library_set_series_grouping,
            commands::library_mutate::library_reset,
            commands::library_mutate::library_get_conversion_queue,
            commands::library_mutate::library_clear_conversion_queue,
            commands::library_mutate::library_get_sync_queue,
            commands::library_mutate::library_clear_sync_queue,
            commands::library_mutate::library_get_default_paths,
            commands::library_mutate::library_get_originals_info,
            commands::library_mutate::library_restore_originals,
            commands::library_mutate::library_purge_originals,
            commands::library_mutate::library_preview_source,
            commands::library_jobs::library_scan,
            commands::library_jobs::library_pause_scan,
            commands::library_jobs::library_resume_scan,
            commands::library_jobs::library_cancel_scan,
            commands::library_jobs::library_convert_all_metadata,
            commands::library_jobs::library_cancel_conversion,
            commands::library_jobs::library_convert_to_cbz,
            commands::library_jobs::library_cancel_cbz_conversion,
            commands::library_jobs::library_cbz_conversion_state,
            commands::library_jobs::library_sync_item,
            commands::library_jobs::library_cancel_sync,
            commands::library_jobs::library_sync_batch,
            commands::library_jobs::library_is_syncing,
